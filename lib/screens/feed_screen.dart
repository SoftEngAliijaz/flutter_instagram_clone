...
class _FeedScreenState extends State<FeedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: width > AppUtils.webScreenSize
          ? AppColors.webBackgroundColor
          : AppColors.mobileBackgroundColor,
      appBar: width > AppUtils.webScreenSize
          ? null
          : AppBar(
          ...
          return ListView.builder(
            ...
            itemBuilder: (ctx, index) => Container(
              margin: EdgeInsets.symmetric(
                horizontal: width > AppUtils.webScreenSize ? width * 0.3 : 0,
                vertical: width > AppUtils.webScreenSize ? 15 : 0,
              ),
              child: PostCard(
